...
- The backend returns paginated results with metadata (total count, pages).
...
- This modular approach allows easy integration of additional bank auction sources without impacting existing code.